...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'bg-background group/calendar p-3 !border !border-input !outline-hidden !ring-0 !`focus:outline-hidden !focus:ring-0 rounded-md [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent',
      ...
      classNames={{
        ...
        button_previous: cn(
          buttonClassName({ variant: 'outlineblack' }),
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'text-primary',
        'group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-primary-500/50',
