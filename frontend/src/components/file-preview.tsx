...
const FilePreview = ({
  ...
  return imagesType.includes(file.type) ? (
    <>
      ...
      >
        ...
        <div className='ml-4 flex flex-shrink-0 items-center space-x-2'>
          <button
            className='inline-block rounded text-xl font-medium text-muted-foreground hover:text-foreground focus:outline-hidden focus:ring focus:ring-primary-500'
    ...
    >
      ...
      <div className='ml-4 flex flex-shrink-0 items-center space-x-2'>
        <UnstyledLink
          className='rounded text-muted-foreground hover:text-foreground focus:outline-hidden focus:ring focus:ring-primary-500'
          href={file.preview}
        >
