...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      'bg-gray/75 backdrop-blur-sm',
      'fixed inset-0 z-[90] overflow-y-auto flex items-end justify-center px-4 pt-4 pb-20 sm:p-0',
...
>((props, ref) => (
  <AlertDialogPrimitive.Description asChild ref={ref} {...props}>
    <Typography className='text-center sm:text-left text-pretty' variant='l'>
      {props.children}
    </Typography>
...
>(({ isLoading, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel asChild ref={ref} {...props}>
    <Button isLoading={isLoading} variant='outlineblack'>
      {props.children}
    </Button>
